...
//typedef struct
//{
//  uint8_t  edAddr[NET_ED_IP_ADDR_SIZE];
//  uint8_t  apAddr[NET_AP_IP_ADDR_SIZE];
//} ip_addr_t;

#define NET_MAC_TYPE_SIZE  2
#define NET_MAC_ADDR_SIZE  NET_ADDR_SIZE+NET_MAC_TYPE_SIZE
...
//typedef struct
//{
//  uint8_t  type[NET_MAC_TYPE_SIZE];
//} type_t;
