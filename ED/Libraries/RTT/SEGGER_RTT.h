...
*/
#define SEGGER_DEBUG
#define SEGGER_SYS_DEBUG
//#define SEGGER_FRMCNT_DEBUG
#define SEGGER_DEBUG1 //”√”⁄µ˜ ‘…‰∆µΩ” ’∫Õ∑¢ÀÕ
//#define SEGGER_MRFI_TX_DEBUG //”√”⁄µ˜ ‘…‰∆µ∑¢ÀÕ
//#define SEGGER_REMOTER_DEBUG //”√”⁄“£øÿ∆˜–≈œ¢
...
void SEGGER_RTT_put_multi_char(unsigned char * multi_char, unsigned short int  len);
void SEGGER_RTT_put_multi_char_no_word_wrap(unsigned char * multi_char, unsigned short int  len);
/*************************** End of file ****************************/
