...
**************************************************************************************************/
// History:     2015-7-28   Laidandan 新增宏定义SMPL_GET_RADIO_PROPERTY,SMPL_SET_RADIO_PROPERTY
//                                    和SMPL_GET_RADIO_PART_INFO.
...
uint8_t send_user_msg(linkID_t , uint8_t *, uint8_t);
#endif  /* EXTENDED_API */
