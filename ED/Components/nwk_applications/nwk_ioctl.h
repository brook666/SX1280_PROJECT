/**************************************************************************************************
  Filename:       nwk_ioctl.h
  Revised:        $Date: 2008-04-29 15:47:05 -0700 (Tue, 29 Apr 2008) $
  Revision:       $Revision: 16972 $
  Author:         $Author: lfriedman $

  Description:    This header file supports the SimpliciTI IOCTL implmentation. This interface
...
smplStatus_t nwk_deviceIPAddress(ioctlAction_t , ip_addr_t *);
