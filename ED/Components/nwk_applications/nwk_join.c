...
/*
 * History:     2014-9-25   Leidi 在nwk_join()中, 如果FLASH中的AP地址有效, 则不使用广播地址.
 *                                修改调试信息.
 *                                删除被注释屏蔽的陈旧代码.
...
//   PRINT_DEBUG_MSG("Send Join frame to AP:\n");
//    PRINT_DEBUG_BYTES(msg, sizeof(msg));
//    PRINT_DEBUG_MSG("\n");
...
//      PRINT_DEBUG_MSG("Recv Join reply from AP:\n");
//      PRINT_DEBUG_BYTES(msg, sizeof(msg));
//      PRINT_DEBUG_MSG("\n");      
      ...
      { 
        ...
        nwk_getNumObjectFromMsg(msg+JR_LINK_TOKEN_OS, &linkToken, sizeof(linkToken));
