/**************************************************************************************************
  ...
  YOU FURTHER ACKNOWLEDGE AND AGREE THAT THE SOFTWARE AND DOCUMENTATION ARE PROVIDED ?S IS?
...
**************************************************************************************************/
// History:     2014-10-28  Leidi   ???NEED_REPLY_FRAME????????????????. 
//              2014-11-10  Leidi   ??FEC_ENABLE,DATARATE_xxx,TX_POWER_x_DBM????mrfi_config?.
//                                  ??TIME_SYNC_SWITCH,SYNC_TIME,NEED_REPLY_FRAME????user_config?.
//              2015-07-18  Leidi   ???ONLY_BELONG_TO_ONE_AP.
//              2015-07-29  Leidi   ??ENABLE_CRC,MANCHESTER_ENCODING??mrfi_config.h???.
//                                  ???ONLY_BELONG_TO_ONE_AP.
...
/* ??????? */
// 0 - ????, 1 - ????
#define TIME_SYNC_SWITCH  1

/* ?AP????????,???????????(??????). */
//#define NEED_REPLY_FRAME
/**************************************************************************************************
*/
